...
follows.dat <- read.csv("/Users/Kat/Documents/2_Research/Fish Follows Manuscript/GitHub/urban-reefs-herbivory/Fish_follows.csv")

rawben.dat <- read.csv("/Users/Kat/Documents/2_Research/Fish Follows Manuscript/GitHub/urban-reefs-herbivory/Supp_Benthic_Data.csv")
```

```{r, Load graphics, message=F, warning=F, echo=F}

# Fish silouettes
# Source: Fishualize R Package (https://github.com/nschiett/fishualize).
...
```{r, DATA EXPLORATION - Histogram, distribution of bites per minute}
...
text(x = par("usr")[1] - 0.1, y = c(1.3, 1.75, 2.6), labels = c("Low", "Medium", "High"), pos = 4, col="red")

```

```{r, DATA EXPLORATION & PLOTS - Spatial NTU trends and SE}
...
```{r, DATA EXPLORATION - SE Benthic Composition}
...
```{r, DATA EXPLORATION & PLOTS - Size of fish across locations/sites}
...
```{r, DATA EXPLORATION & PLOTS - Bite rates across fish size and temperature}
...
##### Plot number of juveniles and adults #######

ontogeny.dat <- rbind(sp.age, cs.age, at.age, ab.age, zf.age, zv.age)
View(ontogeny.dat)
...
#Turf = Main food choice
#Branching = heavy negative correlation with macro and turf 
#Macro = correlated with turf  
#CCA = heavy negative correlation with rubble and sand
#Rubble = heavy negative correlation with CCA
#Sand = negative correlation with turf and CCA

```

#################### Statistics - Foraging Across Turbidity Gradients ####################
...
```{r, QUANTILE REGRESSION, MODELS & PLOTS - all species}
...
```{r, LEAST SQUARES MEANS - Comparing bite rate slopes}
...
# Plot foraging rate means of each species
...
#################### Statistics - Deposited Sediment vs. No Deposited Sediment ####################

```{r, DATA WRANGLING FOR DEPOSITED SEDIMENT MODELS}

### NOTE - Throughout code, SeS ("settled sediment") refers to deposited sediment ###
...
```{r, DEPOSITED SEDIMENT MODEL - C. spilurus}
## All substrates ##
...
```{r, DEPOSITED SEDIMENT MODEL - S. psittacus}
## All substrates ##
...
```{r, DEPOSITED SEDIMENT MODEL - A. triostegus}
## All substrates ##
...
```{r, DEPOSITED SEDIMENT MODEL - A. blochii}
## All substrates ##
...
```{r, DEPOSITED SEDIMENT MODEL - Z. flavescens}
## All substrates ##
...
```{r, DEPOSITED SEDIMENT MODEL - Z. velifer}
## All substrates ##
...
```{r, DEPOSITED SEDIMENT MODEL - N. unicornis and lituratus}
## All substrates ##
...
#################### Selectivity Index - Turbidity Site Groups ####################

```{r, SELECTIVITY INDEX - Load data}
# Bring in data sheets
bites <- read.csv("/Users/Kat/Documents/2_Research/Fish Follows Manuscript/GitHub/urban-reefs-herbivory/strauss_food.csv")
benthos <- read.csv("/Users/Kat/Documents/2_Research/Fish Follows Manuscript/GitHub/urban-reefs-herbivory/strauss_benthos.csv")
...
#################### Selectivity Index - Deposited Sediment vs. No Deposited Sediment ####################  
  
```{r, SELECTIVITY INDEX, SeS DATA WRANGLING}  
sesbites <- read.csv("/Users/Kat/Documents/2_Research/Fish Follows Manuscript/GitHub/urban-reefs-herbivory/strauss_food_ses.csv")
sesbenthos <- read.csv("/Users/Kat/Documents/2_Research/Fish Follows Manuscript/GitHub/urban-reefs-herbivory/strauss_benthos_ses.csv")
